...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 自动注入模式，对应bean属性attribute
	 */
	private int autowireMode = AUTOWIRE_NO;

	/**
	 * 依赖检查，Spring3.0后期弃用这个属性
	 */
	 ...
	 * 将不考虑该bean，即它不会被考虑作为其他bean自动装配的候选者，但是该bean本身还是可以
	 * 使用自动装配来注入其他bean的.
	...
	/**
	 * 定义这个bean的应用，APPLICATION：用户，INFRASTRUCTRUE:完全内部使用，与用户无关，
